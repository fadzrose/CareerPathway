...
protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    // Debugging: Print the updatedDateStr to the console or log
    ...
    Skill skill = new Skill(id, userID, careerID, levelSkill, updatedDateStr);

    // Save the skill object to the database
    try (Connection conn = DriverManager.getConnection(JDBC_URL, JDBC_USER, JDBC_PASSWORD)) {
        String sql = "INSERT INTO skill (id, userID, careerID, level_skill, updated_date) VALUES (?, ?, ?, ?, ?)";
        ...
        try (PreparedStatement stmt = conn.prepareStatement(sql)) {
            ...
            stmt.setDate(5, updatedDate);  // Use the valid updatedDate
